...
class MyOffersModel {
  ...
  MyOffersModel({this.result, this.statusCode});
  ...
  static List<MyOffersModel> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => MyOffersModel.fromJson(map)).toList();
  }
...
class Content {
  ...
  Content({this.id, this.userId, this.token, this.type, this.description, this.createdAt, this.expireAt, this.claim});
